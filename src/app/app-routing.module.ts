...
const routes: Routes = [
  ...
  {path: 'booking-cuerpo', component: BookingBodyComponent},
  {path: 'booking-rostro', component: BookingFacialComponent},
  {path: 'booking-fibroblast', component: BookingFibroblastComponent},
  {path: 'booking-maquillaje', component: BookingMakeupComponent},
  {path: 'booking-maquillaje-permanente', component: BookingPermanentComponent},
  {path: 'booking-tratamientos-especiales', component: BookingSpecialTComponent},
  {path: 'booking-cera', component: BookingWaxComponent},
